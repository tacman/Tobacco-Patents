...
use Acme\DemoBundle\Model\map\PostTableMap;
...
abstract class BasePostPeer {
	...
	const OM_CLASS = 'Acme\\DemoBundle\\Model\\Post';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'src.Acme.DemoBundle.Model.Post';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Content', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'content', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::CONTENT, self::SLUG, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'CONTENT', 'SLUG', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'content', 'slug', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Content' => 2, 'Slug' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'content' => 2, 'slug' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::CONTENT => 2, self::SLUG => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'CONTENT' => 2, 'SLUG' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'content' => 2, 'slug' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
